...
// Button pins
//                         wiringPi, Broadcom
#define playButtonPin 26 // GPIO 26, BCM 12
#define prevButtonPin 23 // GPIO 23, BCM 13
#define nextButtonPin 22 // GPIO 22, BCM  6
#define infoButtonPin 13 // MOSI 12, BCM 10
#define quitButtonPin 2  // GPIO  1, BCM 27
#define shufButtonPin 21 // GPIO 21, BCM  5

#define boardTestPin  27 // GPIO 27, BCM 16 Used to test to see if the LCD/button board is attached or not.

// Rotary encoder
#define encoderPinB   28 // GPIO 28, BCM 20
#define encoderPinA   29 // GPIO 29, BCM 21
#define muteButtonPin 24 // GPIO 24, BCM 19

// LEDs
#define playLedPin   7 // GPIO  7, BCM  4 (green)
#define pauseLedPin  0 // GPIO  0, BCM 17 (yellow)
#define muteLedPin   1 // GPIO  1, BCM 18 (blue)
...
{
    pthread_mutex_lock(&cur_song.pauseMutex);
    // Blink led showing button was pressed
...
int main(int argc, char **argv)
{
    ...
    {
      if (strcmp(argv[0], "lcd-mp3-debug") == 0)
      {
        // TODO
        return usage(argv[0]);
      }
     ...
     * to test if the 'hat' is installed, on the pcb attach
     * wiringPi GPIO 27 (BCM 16) to ground as we have set it up to the pull up resisitor
     */
